"""
Django settings for sprinkled_Magic project.
...
SECRET_KEY = 'django-insecure-w=)o8ysh+qy0b%po%7b1(88mno+g8x5j*d3!^p-44$_h%qxnuw'
...
ROOT_URLCONF = 'sprinkled_Magic.urls'
...
WSGI_APPLICATION = 'sprinkled_Magic.wsgi.application'
